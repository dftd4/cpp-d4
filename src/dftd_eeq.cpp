...
static const double xi[MAXELEMENT]{
  +0.00000000, +1.23695041, +1.26590957, +0.54341808, +0.99666991, +1.26691604,
  ...
  +1.30804834, +1.33689961, +1.27465977, +1.06598299, +0.68184178, +1.25994649,
  +0.40030316, +0.29458157, +0.75460678, +0.42330605, +0.53613714, +0.58870880,
  +0.50349105, +0.02647510, +0.45350118, +0.63133032, +0.45995218, +1.01557723,
  +1.17163176, +0.23501195,
};

static const double gam[MAXELEMENT]{
  // eta (hardness)
  +0.00000000, -0.35015861, +1.04121227, +0.09281243, +0.09412380, +0.26629137,
  ...
  +0.01878626, +0.08715453, +0.10500484, +0.10034731, +0.15801991, -0.00995585,
  +0.13654805, +0.15968516, +0.12442023, +0.13340491, +0.11523968, +0.12165907,
  +0.08181387, +0.65060023, +0.18634958, +0.16685501, +0.15080023, +0.10094112,
  +0.10503808, +0.68963544,
};

static const double kappa[MAXELEMENT]{
  // kcn
  +0.00000000, +0.04916110, +0.10937243, -0.12349591, -0.02665108, -0.02631658,
  ...
  +0.07721851, +0.07936083, +0.05849285, +0.00013506, -0.00020631, +0.00328823,
  +0.00419390, +0.00429264, +0.00193300, +0.00478177, +0.00264040, +0.00418168,
  +0.00399258, -0.00293781, -0.00195990, +0.00148017, -0.00011254, +0.00023249,
  -0.00006144, -0.02459107,
};

static const double alp[MAXELEMENT]{
  // rad
  +0.00000000, +0.55159092, +0.66205886, +0.90529132, +1.51710827, +2.86070364,
  ...
  +1.76613217, +2.66172302, +2.82773085, +1.04059593, +0.60550051, +1.93854984,
  +0.50189075, +0.58180664, +0.73094166, +0.49548126, +0.67685715, +0.59573917,
  +0.35345732, +0.29902232, +0.49626064, +0.55816329, +0.49019371, +1.05120718,
  +0.95651052, +0.35885251,
};
